...
<!-- ======= Contact Section ======= -->
<section id="contact" class="contact" style="padding-top:5% !important;padding-bottom:10% !important; background-color:#f1f7fd !important ;">
      <div class="container">
      ...
      <div class="container">
            ...
            <div class="col-md-2 form-group mx-auto">
                    <input type="text" class="form-control" name="NHS" id="NHS" placeholder="NHS Number" pattern="[0-9]*"required>
                </div>
