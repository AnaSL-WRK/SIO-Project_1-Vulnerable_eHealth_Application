        ...
        <?php 
            ...
            if (isset($_SESSION['userID'])){
              $user = $_SESSION["NHS"];
               ...
               $sql = "SELECT * FROM users WHERE NHS = ?;";
              ...
              $NHS = $row["NHS"];
                  ...
                  echo '<div class="col-md-1"></div>';
                  echo '<div class="col-md-2" style="padding: 10px;">NHS:</div>';
                  ...
                  echo '<form action="phpFunctions/updatepwd.inc.php" method="post" role="form" class="php-email-form" style="background-color:#f1f7fd !important ;">';
